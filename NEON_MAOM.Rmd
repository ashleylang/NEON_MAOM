...
radiocarbon.by.ECM=ggplot(final_data[final_data$Site!= "ORNL",], aes(x=E*100, y=d14C, color=Site))+
  geom_point()+
...
radiocarbon.by.FeOx=ggplot(final_data[final_data$Site!= "ORNL",], aes(x=FeOx, y=d14C, color=Site))+
  geom_point()+
  geom_smooth(method="lm", se=T, linetype="dashed", alpha=0.2)+
  scale_color_viridis_d()+
...
ggarrange(radiocarbon.by.ECM, radiocarbon.by.FeOx, ncol=2, nrow=1, labels= c("a","b"), common.legend=T,legend="right")
ggsave("radiocarbon.by.ECM.FeOx.jpg", path="figures/", width= 24, height= 12, units="cm")
