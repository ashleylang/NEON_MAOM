...
```{r CN.fractions, echo=F, message=F, warning=F}
...
```{r MAT_model, echo=F, message=F, warning=F, eval=F, include=F}
...
#checking slopes
summary(lm(proportion.C_HF~ E, data=final_data %>% filter(Site=="ORNL")))
