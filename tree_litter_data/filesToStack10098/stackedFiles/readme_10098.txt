...
Sensor(s): 
Keywords: net primary productivity (NPP), shrubs, annual net primary productivity (ANPP), tree height, carbon cycle, woody plants, lianas, plants, plant productivity, biomass, vegetation, vegetation structure, trees, canopy height, saplings, production, productivity
Domain: D07
DATA PACKAGE CONTENTS
---------------------
This folder contains the following documentation files:
This data product contains up to 5 data tables:
- Term descriptions, data types, and units: NEON.D07.ORNL.DP1.10098.001.variables.20220829T154025Z.csv
